...
export default function Header() {
  return <header className="w-full bg-slate-900 p-2 grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 md:gap-4 md:p-4">
    <div className='relative flex flex-col bg-white rounded-xl pt-12 pb-4 px-4 md:p-24 md:col-span-2 md:flex-row md:justify-between md:items-end'>
