export default function Description() {
  return <div className='px-4 flex sm:p-12 flex-col items-center md:flex-row md:px-24 md:py-32'>
    <div className='w-full relative h-[420px] sm:w-2/3 md:w-1/2 md:h-[540px]'>
      ...
      <div className="absolute shadow-lg shadow-slate-600 w-3/4 left-[22.5%] top-36 bg-center bg-cover rounded-lg h-64 md:h-96 md:t-40 md:w-2/3 md:left-[28.34%]" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1604549944235-3e5579b15cc2?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)'}}></div>
    </div>
